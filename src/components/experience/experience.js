            ...
            <div className="row">
              ...
              <div className="col-md-9" data-aos="fade-left" data-aos-offset={50} data-aos-duration={500}>
                <div className="card-body">
                  ...
                  <p>■ Perform tasks assigned by the management as per the work flow of their ongoing development projects.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              ...
              <div className="col-md-9" data-aos="fade-left" data-aos-offset={50} data-aos-duration={500}>
                <div className="card-body">
                  ...
                  <p>■ Designed and developed drone simulator consisting of four modes: -City, Village, Green Land and Practice for training,
in Unity 3d using C#.</p>
                  <p>■ Designed and developed energy dashboard web page using D3.js, DC.JS,Crossfilter.js,HTML,CSS,Javascript
ES6,Bootstrap,jQuery.</p>
                </div>
              </div>
            </div>
          </div>
